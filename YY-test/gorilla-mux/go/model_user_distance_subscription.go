...
// AssertUserDistanceSubscriptionRequired checks if the required fields are not zero-ed
func AssertUserDistanceSubscriptionRequired(obj UserDistanceSubscription) error {
	elements := map[string]interface{}{
		"checkImmediate": obj.CheckImmediate,
		"criteria": obj.Criteria,
		"distance": obj.Distance,
		"monitoredAddress": obj.MonitoredAddress,
...
// AssertUserDistanceSubscriptionConstraints checks if the values respects the defined constraints
func AssertUserDistanceSubscriptionConstraints(obj UserDistanceSubscription) error {
